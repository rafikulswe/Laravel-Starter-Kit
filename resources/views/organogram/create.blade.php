            ...
            <div class="collapse show">
                <div class="card-body">
                    <form id="organizationForm" class="from-prevent-multiple-submits"
                        action="{{ route('provider.organogram.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <fieldset class="mb-3">
                            <div class="row">
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            <a id="back" href="{{ route('provider.organogram.index') }}" class="btn btn-light ml-3">Back To List <i class="fas fa-backward ml-2"></i></a>

                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select id="organization_id" name="organization_id"
                                            ...
                                            <option value="{{ $user->organization_id }}">Select</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select id="organogram_ids" name="organogram_ids" class="form-control select-search"
                                            data-fouc>
                                            <option value="{{ $user->organogram_ids }}">Select</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="password" name="password" maxlength="30"
                                            class="form-control maxlength-options" autocomplete="off" placeholder="Enter Your Password">
                                    </div>
                                </div>

    ...
    <div class="content">
        <div class="card">
            ...
            <div class="collapse show">
                <div class="card-body">
                    <form id="myform" action="{{ route('provider.organization.update', [$organizationInfo->id]) }}" method="POST"
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="country_id" name="country_id" class="form-control select-search"
                                            ...
                                            <option value="{{ $country->id }}" @if ($country->id == $organizationInfo->country_id) selected @endif>{{ $country->name_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="division_id" name="division_id" class="form-control select-search"
                                            ...
                                            <option value="{{ $division->id }}" @if ($division->id == $organizationInfo->division_id) selected @endif>{{ $division->name_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="district_id" name="district_id" class="form-control select-search"
                                            ...
                                            <option value="{{ $district->id }}" @if ($district->id == $organizationInfo->district_id) selected @endif>{{ $district->name_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="thana_id" name="thana_id" class="form-control select-search" data-fouc>
                                            ...
                                            <option value="{{ $upazila->id }}" @if ($upazila->id == $organizationInfo->thana_id) selected @endif>{{ $upazila->name_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ $organizationInfo->name }}" maxlength="50"
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="short_name" name="short_name" value="{{ $organizationInfo->short_name }}" maxlength="50"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mobile" name="mobile" value="{{ $organizationInfo->mobile }}" maxlength="32"
                                ...
                                <div class="col-sm-3 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="email" value="{{ $organizationInfo->email }}" maxlength="64"
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a id="back" href="{{ route('provider.organization.index') }}" class="btn btn-light ml-3">Back To List

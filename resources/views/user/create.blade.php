    ...
    <div class="content">
        <div class="card">
            ...
            <div class="collapse show">
                <div class="card-body">
                    <form id="myform" class="from-prevent-multiple-submits" action="{{ route('provider.user.store') }}"
                                ...
                                <div class="col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select placeholder="Select" multiple="multiple" id="organogram_ids" name="organogram_ids[]" class="form-control select-search" data-fouc required>
                                            ...
                                            <option value="{{ $organogram->id }}">{{ $organogram->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone" name="phone" maxlength="11"
                                            class="form-control maxlength-options" placeholder="Enter Your Phone Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="password" name="password" maxlength="30"
                                            class="form-control maxlength-options" placeholder="Enter Your Password"
                                            required>
                                    </div>
                                </div>
